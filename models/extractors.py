...
class ResNet(nn.Module):
    ...
    def __init__(self, block, in_channels, layers=(3, 4, 23, 3)):
        self.inplanes = 64
...
def squeezenet(in_channels, pretrained=True):
    return SqueezeNet(in_channels, pretrained=pretrained)


def densenet(in_channels, pretrained=True):
    return DenseNet(in_channels, pretrained=pretrained)


def resnet18(in_channels, pretrained=True):
...
def resnet34(in_channels, pretrained=True):
...
def resnet50(in_channels, pretrained=True):
...
def resnet101(in_channels, pretrained=True):
...
def resnet152(in_channels, pretrained=True):
